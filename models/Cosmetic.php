	...
	class Cosmetic 
	{
		...
		public function getAll() { 
			...
			$query = (new Select('cosmetics'))
						->joins([['LEFT', 'brands', 'cosmetic_brand_id', 'brand_id'], ['LEFT', 'images', 'cosmetic_id', 'image_cosmetic_id']])
		...
		public function getCosmeticById($id) {
			$db = DB::connect();
			$query = (new Select('cosmetics'))
                        ->joins([['LEFT', 'brands', 'cosmetic_brand_id', 'brand_id'], ['LEFT', 'images', 'cosmetic_id', 'image_cosmetic_id'], ['LEFT', 'countries', 'cosmetic_country_id', 'country_id']])
