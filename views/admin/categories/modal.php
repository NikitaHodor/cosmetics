  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content shadow">
      ...
      <div class="modal-body">
        <form action="<?= SITE_ROOT . 'admin/categoriesEdit/' . $category['category_id'] ?>" method="post">
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content shadow">
      ...
      <div class="modal-footer">
        ...
        <form action="<?= SITE_ROOT . 'admin/categoriesDelete/' . $category['category_id'] ?>" method="post">
...
<div class="modal fade" id="ImageModal<?=$category['category_id'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content shadow">
            ...
            <div class="modal-body">
	        <form enctype="multipart/form-data" action="<?= SITE_ROOT . 'admin/categoriesAddImg/' . $category['category_id'] ?>" method="post">
	        	<div class="form-group">
...
<div class="modal fade" id="ImageEditModal<?=$category['category_id'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content shadow">
            ...
            <div class="modal-body">
	        <form enctype="multipart/form-data" action="<?= SITE_ROOT . 'admin/categoriesEditImg/' . $category['category_id'] ?>" method="post">
	        	<div class="form-group">
	        		<input type="file" class="form-control" name="upload_image">
	        	</div>
