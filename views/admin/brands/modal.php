  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content shadow">
      ...
      <div class="modal-body">
        <form action="<?= SITE_ROOT . 'admin/brandsEdit/' . $brand['brand_id'] ?>" method="post">
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content shadow">
      ...
      <div class="modal-footer">
        ...
        <form action="<?= SITE_ROOT . 'admin/brandsDelete/' . $brand['brand_id'] ?>" method="post">
...
<div class="modal fade" id="ImageModal<?=$brand['brand_id'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content shadow">
            ...
            <div class="modal-body">
	        <form enctype="multipart/form-data" action="<?= SITE_ROOT . 'admin/brandsAddImg/' . $brand['brand_id'] ?>" method="post">
	        	<div class="form-group">
...
<!-- Modal edit image -->
<div class="modal fade" id="ImageEditModal<?=$brand['brand_id'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content shadow">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Изменить изображение  бренда № <?=$brand['brand_id'] ?></h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
	        <form enctype="multipart/form-data" action="<?= SITE_ROOT . 'admin/brandsEditImg/' . $brand['brand_id'] ?>" method="post">
	        	<div class="form-group">
	        		<input type="file" class="form-control" name="upload_image">
	        	</div>
