...
-->
                            ...
                            <td>
                                ...
                                <? else : ?>
                                <a href="<?= SITE_ROOT . 'admin/cosmetics/' . $cosmetic['cosmetic_id'] ?>" class="btn btn-success btn-sm" data-toggle="modal" data-target="#ImageEditModal<?=$cosmetic['cosmetic_id'] ?>"><i class="fa fa-image"></i></a>
                                <? endif; ?>
